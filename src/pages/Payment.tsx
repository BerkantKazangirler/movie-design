        ...
        <div className="flex justify-between pl-75">
          <div className="w-full max-w-128 pt-14">
            ...
            <div className="flex flex-col gap-5 pt-5">
              ...
              <div className="flex flex-col gap-3">
                <label htmlFor="" className="text-xs text-grayscale-70">
                  Cardholder Name
                </label>
                <Input placeholder="" rounded="3xl" />
                <div className="flex flex-row gap-3">
                  ...
                  <div className="flex flex-col w-28 gap-2">
                    ...
                    <Input placeholder="MM/YY" rounded="3xl" />
                  </div>
                  <div className="flex flex-col w-28 gap-2">
                    <label htmlFor="" className="text-xs text-grayscale-70">
                      CVV
                ...
                <div className="flex flex-col w-52 gap-2">
                  ...
                  <Input placeholder="Postal Or Zip Code" rounded="3xl" />
                </div>
              </div>
            </div>
          </div>
          <div className="h-screen bg-dark-smooth w-128 flex">
            <div className="p-16 w-full flex gap-5 flex-col max-h-75">
              ...
              <div className="justify-between flex">
                <span className="text-grayscale-60">Monthly plan discount</span>
                <span>-$5</span>
              </div>
              ...
              <Button padding="normal" margin="8">
                Pay
              </Button>
            </div>
          </div>
